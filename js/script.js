...
var difficolta = prompt('scegli il grado di difficolta fra 0,1,2!!!');
var rangeNumeriCasuali;
if(difficolta == '0'){
  rangeNumeriCasuali = 100;
} else if (difficolta == '1'){
  rangeNumeriCasuali = 80;
} else if (difficolta == '2'){
  rangeNumeriCasuali = 50;
}
console.log('Livello di difficolta: ' + difficolta)
...
console.log('QUESTE SONO LE MIE BOMBE: ', arrayBombe)
...
console.log('PUNTEGGIO MASSIMO: ' + numeroMassimoGiocate);
...
while(bombaBeccata === false && (numeroInsersioniUtente < numeroMassimoGiocate)){
  ...
  console.log('Intento: ' + numeroInsersioniUtente)
}

// Al termine della partita il software deve comunicare il punteggio,
// cioè il numero di volte che l’utente ha inserito un numero consentito.
console.log('PUNTEGGIO UTENTE : ' + numeroInsersioniUtente)
